...
[array]$script:qaChecks = ('c-acc-01-local-users','c-acc-02-local-account-names','c-acc-03-local-admins','c-acc-04-local-groups','c-acc-05-service-logon-accounts',
                           ...
                           'c-com-12-only-one-server-role','c-drv-01-system-drive-size','c-drv-02-min-drive-freespace','c-drv-03-pagefile-size-location','c-drv-04-cd-dvd-drive',
                           'c-drv-05-shared-folders','c-drv-06-san-storage','c-drv-07-disk-management-agent','c-drv-08-drive-ntfs-format','c-drv-09-partition-type',
                           'c-drv-10-attached-images','c-hvh-01-server-core','c-hvh-02-no-other-server-roles','c-hvh-03-vm-location','c-hvh-04-integration-services',
                           'c-hvh-05-jumbo-frames','c-hvh-06-generation-type','c-net-01-ipv6-status','c-net-02-unused-network-interfaces','c-net-03-network-adapter-labels',
                           ...
                           'c-net-09-static-routes','c-net-10-power-management','c-net-11-dns-settings','c-net-12-fileprint-services','c-net-13-netbios-setting',
                           ...
                           'c-sec-16-open-ports','c-sec-17-smb1-disabled','c-sys-01-pending-reboot','c-sys-02-windows-license','c-sys-03-services-not-started',
                           ...
                           'c-sys-15-hibernation','c-sys-16-remote-desktop','c-sys-17-terminal-services-licenced','c-sys-18-check-current-ou','c-sys-19-hp-smh-version',
                           'c-sys-20-dell-oma-version','c-sys-21-gold-image','c-sys-22-all-ram-visible','c-vmw-01-tools-version','c-vmw-02-time-sync','c-vmw-03-nic-type',
                           'c-vmw-04-lsi-sas-controller','c-vmw-05-scsi-drive-count','c-vmw-06-total-vm-size','c-vmw-07-cd-dvd-floppy-mounted','c-vmw-08-failover-clustering')
...
$script:appSettings['ProductName'] = ('')
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
$script:lang['Manual'] = 'Manual'
$script:lang['Not-Applicable'] = 'N/A'
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Software Installed'
<#
    DESCRIPTION: 
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Services Installed'
<#
    DESCRIPTION: 
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Only One Server Role Or Feature'
<#
    DESCRIPTION: 
    ...
    Try
    {
        ...
        ElseIf ($checkOS -like '*201*')    # 2012, 2016
        {
            ...
            [string]$ignoreList     = '|.NET Framework 4.5 Features|.NET Framework 4.6 Features|File and Storage Services|
                                       ...
                                       |Windows Defender Features|Windows PowerShell|WoW64 Support|Telnet Client|'
...
c-com-12-only-one-server-role -serverName $serverName -resultPath $resultPath
}
$cdrv01 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Attached Images'
<#
    DESCRIPTION: 
...
c-drv-10-attached-images -serverName $serverName -resultPath $resultPath
}
$chvh01 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
$script:lang        = @{}
$script:appSettings = @{}
$script:appSettings['RequriedSetting'] = '2'
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
$script:lang['Manual'] = 'Manual'
$script:lang['Not-Applicable'] = 'N/A'
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'NetBIOS Over TCP/IP'
<#
    DESCRIPTION: 
...
c-net-13-netbios-setting -serverName $serverName -resultPath $resultPath
}
$creg01 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
$script:lang        = @{}
$script:appSettings = @{}
$script:appSettings['EventLogName'] = ('')
$script:appSettings['GetLatestEntriesAge'] = '14'
$script:appSettings['GetLatestEntriesCount'] = '15'
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Custom Event Log Errors'
<#
    DESCRIPTION:
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'All RAM Visible'
<#
    DESCRIPTION: 
...
c-sys-22-all-ram-visible -serverName $serverName -resultPath $resultPath
}
$cvmw01 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
$script:qahelp['com12']='<xml><description>Check that only one server role or feature is installed</description><pass>One extra server role or feature installed!n</pass><fail>One or more extra server roles or features installed!n</fail><na>No extra server roles or features installed!n</na><applies>All Servers!n</applies></xml>'
...
$script:qahelp['drv10']='<xml><description>Check to see if any floppy or CD/DVD images are attached to the server</description><pass>No Floppy or CD/DVD images attached!n</pass><fail>One or more Floppy or CD/DVD images attached!n</fail><na>No Floppy or CD/DVD drives found!n</na><applies>All Servers!n</applies></xml>'
