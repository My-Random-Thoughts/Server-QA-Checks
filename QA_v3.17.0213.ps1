...
$script:qahelp['acc07']='<xml><description>Checks the builtin group memberships to make sure specific users or groups are members. This is check 1 of 3 that can be used to check different groups.</description><pass>No additional users exist / Additional users exist</pass><warning>Invalid group name</warning><fail>Additional users exist</fail><applies>All</applies></xml>'
$script:qahelp['acc08']='<xml><description>Checks the builtin group memberships to make sure specific users or groups are members. This is check 2 of 3 that can be used to check different groups.</description><pass>No additional users exist / Additional users exist</pass><warning>Invalid group name</warning><fail>Additional users exist</fail><applies>All</applies></xml>'
$script:qahelp['acc09']='<xml><description>Checks the builtin group memberships to make sure specific users or groups are members. This is check 3 of 3 that can be used to check different groups.</description><pass>No additional users exist / Additional users exist</pass><warning>Invalid group name</warning><fail>Additional users exist</fail><applies>All</applies></xml>'
