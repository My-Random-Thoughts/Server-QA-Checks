...
[array]$script:qaChecks = ('c-acc-01-local-users','c-acc-02-local-account-names','c-acc-03-local-admins','c-acc-04-local-groups','c-acc-05-service-logon-accounts',
                           ...
                           'c-sys-12-snmp-configuration','c-sys-13-domain-member','c-sys-13-domain-user-logon','c-sys-14-power-plan','c-sys-15-hibernation','c-sys-16-remote-desktop',
                           ...
                           'c-vmw-08-check-vosot-registry','c-vmw-09-check-vosot-services-tasks')
