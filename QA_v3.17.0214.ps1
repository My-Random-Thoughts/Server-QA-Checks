...
$script:qahelp['sec16']='<xml><description>Returns a list of ports that are open, excluding anything higher than 49152</description><pass>No extra ports are open</pass><fail>One or more extra ports are open</fail><na>This check is for local servers only</na><applies>All</applies></xml>'
