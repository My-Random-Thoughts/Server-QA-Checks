...
[array]$script:qaChecks = ('c-acc-01-local-users','c-acc-02-local-account-names','c-acc-03-local-admins','c-acc-04-local-groups','c-acc-05-service-logon-accounts',
                           ...
                           'c-drv-09-partition-type','c-hvh-01-server-core','c-hvh-02-no-other-server-roles','c-hvh-03-vm-location','c-hvh-04-integration-services',
...
$script:qahelp['drv09']='<xml><description>Ensure all drives types are set to BASIC and with a partition style of</description><pass>All drive types are BASIC, with partition styles of</pass><fail>One or more partition styles are not MBR / One or more drives types are not</fail><manual>Unable to get drive information, please check manually</manual><applies>All</applies></xml>'
