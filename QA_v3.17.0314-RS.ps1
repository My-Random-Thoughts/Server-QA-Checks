...
[array]$script:qaChecks = ('c-acc-01-local-users','c-acc-02-local-account-names','c-acc-03-local-admins','c-acc-04-local-groups','c-acc-05-service-logon-accounts',
                           ...
                           'c-com-03-sccm-installed','c-com-04-netbackup-agent-installed','c-com-05-last-patch-date','c-com-06-wsus-server','c-drv-01-system-drive-size',
                           'c-drv-02-min-drive-freespace','c-drv-03-pagefile-size-location','c-drv-04-cd-dvd-drive','c-drv-05-shared-folders','c-drv-06-san-storage',
                           'c-drv-07-disk-management-agent','c-drv-08-drive-ntfs-format','c-drv-09-partition-type','c-hvh-01-server-core','c-hvh-02-no-other-server-roles',
                           'c-hvh-03-vm-location','c-hvh-04-integration-services','c-net-01-no-ipv6','c-net-02-unused-network-interfaces','c-net-03-network-adapter-labels',
                           'c-net-04-binding-order','c-net-05-network-speed-duplex','c-net-06-network-agent','c-net-07-network-teaming','c-net-08-management-adapter',
                           'c-net-09-static-routes','c-net-10-power-management','c-net-11-dns-settings','c-net-12-fileprint-services','c-reg-01-local-time','c-reg-02-timezone',
                           ...
                           'c-sec-12-smb-signing-on','c-sec-13-rsa-authentication','c-sec-14-firewall-rules','c-sec-15-firewall-state','c-sec-16-open-ports',
                           'c-sys-01-pending-reboot','c-sys-02-windows-license','c-sys-03-services-not-started','c-sys-04-services-not-stopped','c-sys-05-system-event-log',
                           'c-sys-06-application-event-log','c-sys-07-devices-status','c-sys-09-scheduled-tasks','c-sys-10-print-spooler','c-sys-11-autorun-disabled',
                           'c-sys-12-snmp-configuration','c-sys-13-domain-member','c-sys-14-power-plan','c-sys-15-hibernation','c-sys-16-remote-desktop','c-sys-17-terminal-services-licenced',
                           'c-sys-18-check-current-ou','c-vhv-01-tools-version','c-vmw-01-tools-version','c-vmw-02-time-sync','c-vmw-03-nic-type','c-vmw-04-lsi-sas-controller',
                           'c-vmw-05-scsi-drive-count','c-vmw-06-total-vm-size','c-vmw-07-cd-dvd-floppy-mounted')
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'IPv6 Disabled'
<#
    DESCRIPTION: 
...
c-net-01-no-ipv6 -serverName $serverName -resultPath $resultPath
}
$cnet02 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
#                    [string]$source = Invoke-Command                           -ScriptBlock { &"$env:SystemRoot\System32\w32tm.exe" /query /source } -ErrorAction SilentlyContinue
                    [string]$source = Process-Start -FilePath "$env:SystemRoot\System32\w32tm.exe" -Arguments '/query /source'
                }
                Else {
...
$script:lang        = @{}
$script:appSettings = @{}
$script:appSettings['IgnoreTheseFirewallAppRules'] = ('Microsoft', 'McAfee', 'macmnsvc', 'System Center', 'nbwin', 'Java', 'Firefox', 'Chrome')
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
$script:lang['Manual'] = 'Manual'
$script:lang['Not-Applicable'] = 'N/A'
...
#       $script:appSettings['IgnoreThesePorts'] +=  '0000'    # 
        ...
        Try
        {
            ...
            [string[]]$dynPorts = Process-Start -FilePath 'netsh.exe' -Arguments 'int ipv4 show dynamicportrange tcp'
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'System Event Log Errors'
<#
    DESCRIPTION: 
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Application Event Log Errors'
<#
    DESCRIPTION: 
...
$script:lang        = @{}
$script:appSettings = @{}
$script:appSettings['NoInTheseOUs'] = ('ou=Computers,dc=ACME,dc=LAN', 'ou=Quarantine,dc=ACME,dc=LAN')
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
$script:lang['Manual'] = 'Manual'
$script:lang['Not-Applicable'] = 'N/A'
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'HyperV Tools Version'
<#
    DESCRIPTION: 
...
c-vhv-01-tools-version -serverName $serverName -resultPath $resultPath
}
$cvmw01 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'VMware Tools Version'
<#
    DESCRIPTION: 
...
#                $check = Invoke-Command                           -ScriptBlock { &"$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" help } -ErrorAction SilentlyContinue }
                $versi = (Process-Start -FilePath "$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" -Arguments   '-v')
                $check = (Process-Start -FilePath "$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" -Arguments 'help')
            }
            Else
            {
...
#                {      $check = Invoke-Command                           -ScriptBlock { &"$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" upgrade status } -ErrorAction SilentlyContinue }
                If ($serverName -eq $env:ComputerName)
                {
                    $check = (Process-Start -FilePath "$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" -Arguments 'upgrade status')
                }
                Else
                {
                    $check = Invoke-Command -ComputerName $serverName -ScriptBlock { &"$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" upgrade status } -ErrorAction SilentlyContinue
                }
            }
        }
        Catch { }
...
#                $check = Invoke-Command                           -ScriptBlock { &"$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" timesync status } -ErrorAction SilentlyContinue
                $check = (Process-Start -FilePath "$env:ProgramFiles\VMware\VMware Tools\VMwareToolBoxCmd.exe" -Arguments 'timesync status')
            }
            Else
            {
...
$script:lang        = @{}
$script:appSettings = @{}
$script:appSettings['vosotXmlFile'] = 'C:\ProgramData\VMware\OSOT\VMware Templates\636014.xml'
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
$script:lang['Manual'] = 'Manual'
$script:lang['Not-Applicable'] = 'N/A'
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Check vOSOT Settings (Registry)'
<#
    DESCRIPTION: 
...
c-vmw-08-check-vosot-registry -serverName $serverName -resultPath $resultPath
}
$cvmw09 = {
Param ($serverName,$resultPath)
Function newResult { Return ( New-Object -TypeName PSObject -Property @{'server'=''; 'name'=''; 'check'=''; 'datetime'=(Get-Date -Format 'yyyy-MM-dd HH:mm'); 'result'='Unknown'; 'message'=''; 'data'='';} ) }
...
$script:lang['Script-Error'] = 'SCRIPT ERROR'
$script:lang['Warning'] = 'Warning'
$script:lang['Name'] = 'Check vOSOT Settings (Services And Tasks)'
<#
    DESCRIPTION: 
...
c-vmw-09-check-vosot-services-tasks -serverName $serverName -resultPath $resultPath
}
##############################################################################################################################################################################################
...
$script:qahelp['drv03']='<xml><description>Check the page file is located on the system drive and is a fixed size.  The default setting is 4096MB (4GB).If the page file is larger a document detailing the tuning process used must exist and should follow Microsoft best tuning practices (http://support.microsoft.com/kb/2021748).</description><requiredinputs>FixedPageFileSize - Fixed size in MB of the page file|Integer!n</requiredinputs><pass>Pagefile is set correctly!n</pass><fail>Pagefile is system managed, it should be set to a custom size of {size}mb!nPagefile should be set on the system drive, to Custom, with Initial and Maximum sizes set to {size}mb!nPagefile does not exist on {letter} drive!n</fail><manual>Unable to get page file information, please check manually!n</manual><applies>All Servers!n</applies></xml>'
...
$script:qahelp['drv09']='<xml><description>Ensure all drives types are set to BASIC and with a partition style of MBR.</description><pass>All drive types are BASIC, with partition styles of MBR!n</pass><fail>One or more partition styles are not MBR!nOne or more drives types are not BASIC!n</fail><applies>All Servers!n</applies></xml>'
...
$script:qahelp['hvh04']='<xml><description>Check the version of the Integration Services.</description><fail>Registry setting not found!n</fail><manual>Integration services found!n</manual><na>Not a Hyper-V server!n</na><applies>Hyper-V Host Servers!n</applies></xml>'
$script:qahelp['net01']='<xml><description>Check IPv6 has been unbound on all active NICs, or globally.</description><pass>IPv6 disabled globally!nIPv6 enabled globally, but disabled on all NICs!n</pass><fail>IPv6 enabled globally, and NIC(s) found with IPv6 enabled!n</fail><applies>All Servers!n</applies></xml>'
...
$script:qahelp['net11']='<xml><description>Checks that all DNS servers are configured, and if required, in the right order.</description><requiredinputs>DNSServers    - List of DNS IP addresses that you want to check|IPv4!nOrderSpecific - "True|False" - Should the DNS order match exactly for a Pass.?!n</requiredinputs><pass>All DNS servers configured (and in the right order)!n</pass><fail>DNS Server count mismatch!nMismatched DNS servers!nDNS Server list is not in the required order!nNo DNS servers are configured!n</fail><applies>All Servers!n</applies></xml>'
...
$script:qahelp['sec09']='<xml><description>Ensure the system is set to request administrative credentials before granting an application elevated privileges.Default setting is either "(1):Prompt for credentials on the secure desktop" or "(3):Prompt for credentials"Values and meanings can be seen here - https://msdn.microsoft.com/en-us/library/cc232761.aspx</description><requiredinputs>ElevatePromptForAdminCredentials - "1,2,3,4,5" - List of settings to check for!n</requiredinputs><pass>Prompt for credentials is enabled!n</pass><fail>System is not set to "Prompt for credentials" when launching an application with elevated privileges!nRegistry setting not found!n</fail><applies>All Servers!n</applies></xml>'
...
$script:qahelp['sys05']='<xml><description>Check System Event Log and ensure no errors are present in the last x days.  If found, will return the latest y entries</description><requiredinputs>GetLatestEntriesAge   - Return all entries for this number of days|Integer!nGetLatestEntriesCount - Return this number of entries|Integer!n</requiredinputs><pass>No errors found in system event log!n</pass><warning>Errors were found in the system event log!n</warning><applies>All Servers!n</applies></xml>'
$script:qahelp['sys06']='<xml><description>Check Application Event Log and ensure no errors are present in the last x days.  If found, will return the latest y entries</description><requiredinputs>GetLatestEntriesAge   - Return all entries for this number of days|Integer!nGetLatestEntriesCount - Return this number of entries|Integer!n</requiredinputs><pass>No errors found in application event log!n</pass><warning>Errors were found in the application event log!n</warning><applies>All Servers!n</applies></xml>'
...
$script:qahelp['vhv01']='<xml><description>Check that the latest HyperV integration services are installed.</description><fail>Integration services not installed!n</fail><manual>Integration services found!n</manual><na>Not a virtual machine!n</na><applies>Virtual Servers!n</applies></xml>'
$script:qahelp['vmw01']='<xml><description>Check that the latest vmware tools are installed.</description><pass>VMware tools are up to date!n</pass><fail>VMware tools can be upgraded!n</fail><manual>Unable to check the VMware Tools upgrade status!n</manual><na>Not a virtual machine!n</na><applies>Virtual Servers!n</applies></xml>'
...
$script:qahelp['vmw08']='<xml><description>Checks against a specified VMware OS Optimisation Template.  Registry setting specific checks only.(Experimental Check)</description><requiredinputs>vosotXmlFile - Local path to the confoguration XML file for VMware OSOT|File!n</requiredinputs><pass>All mandatory and recommended settings configured!n</pass><warning>All mandatory settings configured, recommended settings not configured!n</warning><fail>All mandatory and recommended settings not configured!n</fail><na>Not a virtual machine!nXML check file not applicable for this server!n</na><applies>Virtual Servers!n</applies></xml>'
$script:qahelp['vmw09']='<xml><description>Checks against a specified VMware OS Optimisation Template.  Services and scheduled task setting specific checks only.(Experimental Check)</description><requiredinputs>vosotXmlFile - Local path to the confoguration XML file for VMware OSOT|File!n</requiredinputs><pass>All mandatory and recommended settings configured!n</pass><warning>All mandatory settings configured, recommended settings not configured!n</warning><fail>All mandatory and recommended settings not configured!n</fail><na>Not a virtual machine!nXML check file not applicable for this server!n</na><applies>Virtual Servers!n</applies></xml>'
