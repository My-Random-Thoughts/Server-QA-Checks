...
[array]$script:qaChecks = ('c-acc-01-local-users','c-acc-02-local-account-names','c-acc-03-local-admins','c-acc-04-local-groups','c-acc-05-service-logon-accounts',
                           ...
                           'c-com-03-sccm-installed','c-com-04-netbackup-agent-installed','c-com-05-last-patch-date','c-com-06-wsus-server','c-com-07-sentinel-agent-installed',
                           ...
                           'c-hvh-02-no-other-server-roles','c-hvh-03-vm-location','c-hvh-04-integration-services','c-net-01-no-ipv6','c-net-02-unused-network-interfaces',
                           ...
                           'c-net-08-management-adapter','c-net-09-static-routes','c-net-10-power-management','c-net-11-dns-settings','c-net-12-fileprint-services',
                           'c-reg-01-local-time','c-reg-02-timezone','c-reg-03-location','c-reg-04-language','c-sec-01-schannel-p1-ciphers','c-sec-02-schannel-p2-hashes',
                           'c-sec-03-schannel-p3-keyexchangealgorithms','c-sec-04-schannel-p4-protocols','c-sec-05-schannel-p5-cipher-order','c-sec-06-reject-enumerate-accounts',
                           'c-sec-07-reject-enumerate-shares','c-sec-08-domain-credential-caching','c-sec-09-request-admin-elevated','c-sec-10-anonymous-pipe-share-access',
                           'c-sec-11-iis-default-page','c-sec-12-smb-signing-on','c-sec-13-rsa-authentication','c-sec-14-firewall-rules','c-sec-15-firewall-state',
                           'c-sec-16-open-ports','c-sys-01-pending-reboot','c-sys-02-windows-license','c-sys-03-services-not-started','c-sys-04-services-not-stopped',
                           ...
                           'c-sys-11-autorun-disabled','c-sys-12-snmp-configuration','c-sys-13-domain-member','c-sys-14-power-plan','c-sys-15-hibernation','c-sys-16-remote-desktop',
                           'c-sys-17-terminal-services-licenced','c-sys-18-check-current-ou','c-vhv-01-tools-version','c-vmw-01-tools-version','c-vmw-02-time-sync',
...
$script:lang        = @{}
$script:appSettings = @{}
$script:appSettings['IgnoreTheseFirewallAppRules'] = ('Microsoft', 'McAfee', 'macmnsvc', 'System Center', 'nbwin')
$script:lang['Error'] = 'Error'
$script:lang['Fail'] = 'Fail'
$script:lang['Manual'] = 'Manual'
$script:lang['Not-Applicable'] = 'N/A'
...
$script:qahelp['net11']='<xml><description>Checks that all DNS servers are configured, and if required, in the right order.</description><requiredinputs>DNSServers    - "True|False" - Should the DNS order match exactly for a Pass.?!nOrderSpecific - List of DNS IP addresses that you want to check|IPv4!n</requiredinputs><pass>All DNS servers configured (and in the right order)!n</pass><fail>DNS Server count mismatch!nMismatched DNS servers!nDNS Server list is not in the required order!nNo DNS servers are configured!n</fail><applies>All Servers!n</applies></xml>'
