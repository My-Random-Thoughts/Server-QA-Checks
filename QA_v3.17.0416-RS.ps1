...
[array]$script:qaChecks = ('c-acc-01-local-users','c-acc-02-local-account-names','c-acc-03-local-admins','c-acc-04-local-groups','c-acc-05-service-logon-accounts',
                           ...
                           'c-hvh-02-no-other-server-roles','c-hvh-03-vm-location','c-hvh-04-integration-services','c-hvh-05-jumbo-frames','c-net-01-no-ipv6',
                           'c-net-02-unused-network-interfaces','c-net-03-network-adapter-labels','c-net-04-binding-order','c-net-05-network-speed-duplex','c-net-06-network-agent',
                           'c-net-07-network-teaming','c-net-08-management-adapter','c-net-09-static-routes','c-net-10-power-management','c-net-11-dns-settings',
                           'c-net-12-fileprint-services','c-reg-01-local-time','c-reg-02-timezone','c-reg-03-location','c-reg-04-language','c-sec-01-schannel-p1-ciphers',
                           'c-sec-02-schannel-p2-hashes','c-sec-03-schannel-p3-keyexchangealgorithms','c-sec-04-schannel-p4-protocols','c-sec-05-schannel-p5-cipher-order',
                           ...
                           'c-sec-15-firewall-state','c-sec-16-open-ports','c-sys-01-pending-reboot','c-sys-02-windows-license','c-sys-03-services-not-started',
