...
$script:qahelp['com12']='<xml><description>Check that only one server role or feature is installed</description><pass>No extra server roles or features exist!n</pass><fail>One or more extra server roles or features exist!n</fail><applies>All Servers!n</applies></xml>'
